...
/**
 * Helps build diagon HTTP requests.
 */
export class DiagonHttp {
  private apiUrl: string;
  private headers: { [key: string]: string } = {};

  /**
   * Generates a new instance of DiagonHttp.
   * @param baseUrl the base url, without the vX version: https://mugle.org -> goes to https://mugle.org/api/vX
